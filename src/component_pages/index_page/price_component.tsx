type propsPriceComponent = {
    title: string,
    total_article?: number | 'no_article' | 'unlimited_article',
    total_video?: number | 'no_video' | 'unlimited_video'
}

export default function PriceComponent({ title, total_article, total_video }: propsPriceComponent) {
    return (
